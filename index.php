  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
        ...
        <div class="home-banner" > <img style="width: 100%; " src="assets/images/banners/shoe.jpg
        " alt="Image"> </div>
      </div>
      <!-- /.sidemenu-holder --> 
      <!-- ============================================== SIDEBAR : END ============================================== --> 
       ...
       <?php  include_once('./newProducts.php') ?> 
          ...
          <div class="row">
            <div class="col-md-7 col-sm-7">
              <div class="wide-banner cnt-strip">
                <div class="image"> <img style="object-fit: cover; height: 180px; width: 100%" class="" src="assets/images/banners/banner-big.jpg" alt=""> </div>
              </div>
              <!-- /.wide-banner --> 
            </div>
            <!-- /.col -->
            <div class="col-md-5 col-sm-5">
              <div class="wide-banner cnt-strip">
                <div class="image"> <img style="height: 180px" class="" src="assets/images/banners/banner-small.jpg" alt=""> </div>
              </div>
              <!-- /.wide-banner --> 
            </div>
            <!-- /.col --> 
        ...
        <div class="wide-banners wow fadeInUp outer-bottom-xs">
          <div class="row">
            <div class="col-md-12">
              <div class="wide-banner cnt-strip">
                <div class="image" style="position:relative; z-index: 5 "> <img class="img-responsive" style="position:relative; z-index: 4;" src="assets/images/banners/banner-big-big.png" alt=""> 
                <div class="color-transprant" style="background: rgba(5, 5, 5, 0.5); position:absolute; width: 100%; height:100%; z-index:100; top:0; left:0 "></div>
              </div>
                <div class="strip strip-text" style="position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); z-index:6">
                  <div class="strip-inner text-center">
                    <h2 class="">New Mens Fashion<br>
        ...
        <!-- ============================================== FEATURED PRODUCTS ============================================== -->
       <?php  include_once('./newArriavls.php') ?>
        <!-- /.section --> 
